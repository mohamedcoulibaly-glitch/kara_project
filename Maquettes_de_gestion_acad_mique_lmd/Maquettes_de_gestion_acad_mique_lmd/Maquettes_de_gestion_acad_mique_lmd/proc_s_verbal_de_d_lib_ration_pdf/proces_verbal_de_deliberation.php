...
<div class="text-lg font-bold tracking-tight text-blue-800 dark:text-blue-300">Délibération Académique</div>
...
<h1 class="font-headline font-extrabold text-lg text-on-surface uppercase tracking-tight">Université des Sciences Appliquées</h1>
<p class="text-sm font-medium text-secondary">Faculté des Sciences et Technologies</p>
<p class="text-xs text-outline italic">Département de Génie Logiciel</p>
</div>
<div class="col-span-3 text-right flex flex-col justify-center">
<div class="bg-surface-container-low p-3 rounded-lg">
<p class="text-[10px] font-bold text-outline-variant uppercase">Année Académique</p>
...
<h2 class="font-headline font-black text-2xl text-on-surface tracking-tighter uppercase mb-1">Procès-Verbal de Délibération Finale</h2>
<div class="flex justify-center items-center gap-4">
<span class="h-px w-12 bg-outline-variant"></span>
<p class="text-md font-bold text-primary tracking-widest uppercase">Semestre 1 (S1) - Licence Génie Logiciel</p>
<span class="h-px w-12 bg-outline-variant"></span>
</div>
</section>
<!-- Data Grid -->
...
<th class="py-3 px-4 text-center last:rounded-r-md">Décision</th>
</tr>
</thead>
<tbody class="text-sm font-medium">
<tr class="hover:bg-surface-container-low transition-colors group">
<td class="py-4 px-4 text-outline font-mono">2023-GL-001</td>
<td class="py-4 px-4 text-on-surface">KOUAMÉ Marc-Antoine</td>
...
<td class="py-4 px-4 text-center">
<span class="bg-error-container text-on-error-container px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider">Ajourné</span>
</td>
</tr>
</tbody>
</table>
...
<span class="text-[10px] uppercase font-black tracking-widest text-outline mb-2">Taux de Réussite</span>
<span class="text-3xl font-black text-primary">40.0%</span>
<span class="text-[10px] text-on-surface-variant font-medium mt-1">2/5 Étudiants Admis</span>
</div>
<div class="bg-surface-container-low p-6 rounded-xl flex flex-col items-center">
...
<div class="bg-surface-container-low p-6 rounded-xl flex flex-col items-center">
<span class="text-[10px] uppercase font-black tracking-widest text-outline mb-2">Effectif Présent</span>
...
<p class="text-xs font-bold text-on-surface uppercase mb-12">Le Chef de Département</p>
...
<div class="text-center">
<p class="text-xs font-bold text-on-surface uppercase mb-12">Le Président du Jury</p>
<div class="w-full border-t border-slate-200 pt-2">
<p class="text-[10px] text-outline font-medium">Signature &amp; Cachet</p>
</div>
</div>
...
<span class="text-[9px] text-outline-variant font-bold uppercase tracking-tight">Vérifié par Système Académique LMD</span>
</div>
<p class="text-[8px] text-outline italic">Date d'édition : 24 Mai 2024 - Réf : PV-S1-GL-2023-0042</p>
</div>
</main>
...
<div class="font-inter text-[10px] uppercase tracking-widest text-slate-400">© 2024 Système de Gestion LMD Académique - Document Officiel</div>
<div class="flex gap-8">
<a class="font-inter text-[10px] uppercase tracking-widest text-slate-400 hover:text-blue-700 transition-colors" href="#">Mentions Légales</a>
...
<a class="font-inter text-[10px] uppercase tracking-widest text-slate-400 hover:text-blue-700 transition-colors" href="#">Règlement LMD</a>
</div>
</footer>
</body></html>