...
<p class="text-xs text-slate-500 font-medium font-inter">Portail DÃ©cisionnel</p>
</div>
...
<img alt="Profil Administrateur" class="w-full h-full object-cover" data-alt="Avatar de l'administrateur systÃ¨me" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCVUxjADK_fKpqKuivBQYpFAw7dzZffHnnp5lRy4qkn0_cBjY4tslTYzVsLs5aG2SB__Gx8PPpU-H9-op0uoxGWYnTOzv9VSPzu0p5XNhjsekTWMwNCsTtFM_BIaX0dr08BTImOafrsfXcgHrV6Af6lFMqghrRS7wH3ocDVNvaTBv7HYMCTTAd9ejwGDdh0s8MYxsmdWYe4GUNCKHnTS6HAAmb7C9WcJyvmfeOPsq4d1BwOJAOoEzyZhbFU2TQ9h-luhUnM06Qv4tU"/>
</div>
</div>
</div>
</header>
...
<div>
<h2 class="text-3xl font-extrabold text-on-surface tracking-tight mb-1">Statistiques de RÃ©ussite par DÃ©partement</h2>
<p class="text-on-surface-variant text-sm">Analyse comparative des performances acadÃ©miques</p>
</div>
...
<option>AnnÃ©e 2023-2024</option>
<option>AnnÃ©e 2022-2023</option>
</select>
</div>
...
<span class="text-xs font-bold text-secondary uppercase tracking-wider">RÃ©ussite Globale</span>
</div>
...
<p class="text-xs text-on-surface-variant mt-2 font-medium">Par rapport au semestre prÃ©cÃ©dent</p>
...
<span class="text-xs font-bold text-primary uppercase tracking-wider">Moyenne GÃ©nÃ©rale</span>
</div>
<div class="flex items-baseline gap-2">
...
<span class="text-xs font-bold text-tertiary uppercase tracking-wider">ECTS ValidÃ©s</span>
</div>
<div class="flex items-baseline gap-2">
...
<p class="text-xs text-on-surface-variant mt-2 font-medium">CrÃ©dits accumulÃ©s par les Ã©tudiants</p>
...
<h3 class="font-bold text-lg text-on-surface">Comparaison par DÃ©partement (%)</h3>
<div class="flex gap-2">
<div class="flex items-center gap-1.5">
<span class="w-3 h-3 rounded-full bg-primary"></span>
<span class="text-xs font-medium text-on-surface-variant">RÃ©ussite</span>
</div>
</div>
</div>
...
<h3 class="font-bold text-lg text-on-surface mb-8">RÃ©partition des Mentions</h3>
...
<h3 class="font-bold text-lg text-on-surface">DÃ©tails par DÃ©partement</h3>
<div class="flex gap-2">
...
<th class="px-6 py-4 text-xs font-bold uppercase tracking-widest text-on-surface-variant">DÃ©partement</th>
<th class="px-6 py-4 text-xs font-bold uppercase tracking-widest text-on-surface-variant text-right">Ã‰tudiants</th>
<th class="px-6 py-4 text-xs font-bold uppercase tracking-widest text-on-surface-variant text-right">Moyenne</th>
<th class="px-6 py-4 text-xs font-bold uppercase tracking-widest text-on-surface-variant text-right">Taux de RÃ©ussite</th>
...
<span class="text-xs text-on-surface-variant">FacultÃ© des Sciences</span>
</div>
</td>
...
<span class="inline-flex items-center px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider bg-secondary-container text-on-secondary-container">82.0% VALIDÃ‰</span>
</td>
<td class="px-6 py-5 text-right">
<button class="text-xs font-bold text-primary hover:text-on-primary-fixed-variant transition-colors">Voir dÃ©tails par filiÃ¨re</button>
</td>
</tr>
<tr class="hover:bg-surface-container-low transition-colors group">
<td class="px-6 py-5">
...
<span class="text-xs text-on-surface-variant">Ã‰cole de Management</span>
</div>
</td>
...
<td class="px-6 py-5 text-right">
<span class="inline-flex items-center px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider bg-secondary-container text-on-secondary-container">74.5% VALIDÃ‰</span>
</td>
<td class="px-6 py-5 text-right">
<button class="text-xs font-bold text-primary hover:text-on-primary-fixed-variant transition-colors">Voir dÃ©tails par filiÃ¨re</button>
</td>
...
<span class="text-xs text-on-surface-variant">FacultÃ© des Sciences Humaines</span>
</div>
</td>
...
<td class="px-6 py-5 text-right">
<span class="inline-flex items-center px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider bg-secondary-container text-on-secondary-container">89.4% VALIDÃ‰</span>
</td>
<td class="px-6 py-5 text-right">
<button class="text-xs font-bold text-primary hover:text-on-primary-fixed-variant transition-colors">Voir dÃ©tails par filiÃ¨re</button>
</td>
