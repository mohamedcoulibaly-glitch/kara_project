...
<input class="bg-transparent border-none focus:ring-0 text-sm w-64" placeholder="Rechercher un Ã©tudiant..." type="text"/>
</div>
</div>
...
<div>
<h2 class="font-black text-blue-800 dark:text-blue-300 text-sm leading-tight uppercase tracking-wider">Portail AcadÃ©mique</h2>
...
<span class="text-sm font-medium">FiliÃ¨res</span>
</a>
<a class="flex items-center gap-3 px-4 py-3 text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-300 hover:bg-white/50 dark:hover:bg-slate-800/50 transition-all group rounded-lg" href="#">
<span class="material-symbols-outlined group-hover:translate-x-1 duration-200">group</span>
<span class="text-sm font-medium">Ã‰tudiants</span>
</a>
...
<p class="text-on-surface-variant text-sm mt-1">Ã‰valuation continue et examen final</p>
</div>
<div class="flex items-center gap-3">
...
<label class="text-[10px] uppercase font-bold text-outline tracking-wider px-1">FiliÃ¨re</label>
...
<div class="flex flex-col gap-1">
<label class="text-[10px] uppercase font-bold text-outline tracking-wider px-1">UnitÃ© d'Enseignement (UE)</label>
...
<span class="text-sm font-semibold">MathÃ©matiques I</span>
</div>
</div>
<span class="material-symbols-outlined text-outline-variant">chevron_right</span>
<div class="flex flex-col gap-1">
<label class="text-[10px] uppercase font-bold text-outline tracking-wider px-1">Ã‰lÃ©ment Constitutif (EC)</label>
...
<span class="text-sm font-semibold">AlgÃ¨bre</span>
</div>
</div>
<div class="ml-auto flex items-center gap-4">
<div class="h-10 w-[1px] bg-outline-variant/30"></div>
<div class="flex flex-col items-end">
<span class="text-[10px] uppercase font-bold text-outline tracking-wider">CrÃ©dits</span>
...
<th class="px-6 py-4 text-[11px] font-bold text-outline uppercase tracking-widest">Nom &amp; PrÃ©nom</th>
...
<span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-secondary-container text-on-secondary-container">ValidÃ©</span>
</td>
</tr>
<tr class="hover:bg-surface-container-low transition-colors group">
...
<div>
<p class="text-[11px] font-bold text-outline uppercase tracking-wider">Taux de RÃ©ussite</p>
...
<div>
<p class="text-[11px] font-bold text-primary-fixed-dim uppercase tracking-wider">Moyenne PondÃ©rÃ©e UE</p>
...
<span class="px-3 py-1 bg-white text-primary text-[10px] font-black rounded-full uppercase tracking-tighter">ValidÃ©e</span>
</div>
</div>
</div>
...
<span class="w-2 h-2 rounded-full bg-emerald-400 animate-pulse"></span>
                Toutes les modifications sont synchronisÃ©es localement
            </div>
</div>
</main>
</body></html>
