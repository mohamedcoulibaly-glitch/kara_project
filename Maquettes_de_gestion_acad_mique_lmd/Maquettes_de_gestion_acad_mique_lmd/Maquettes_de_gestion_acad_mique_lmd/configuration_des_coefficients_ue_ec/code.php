...
<span class="text-lg font-bold text-[#1A56DB]">Portail Académique LMD</span>
</div>
...
<img alt="Avatar" data-alt="Avatar de l'administrateur académique" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBBIUzauJgd0Baep-AX3Ny_GBQKYjathfxgmWT4k8yiz8qCWAZoxn4ayWuH9SJo1eDlndLWuy5bCjMWluPP_3pZW7SKfB6vxqell_vmmnQ3lMPzfri4Vjn9hw0e0kwbs2JasAUbbEEGHPfiaVOM5biYeEnJxA1B6aDttQDKRJesS3yI-LeOFC6Lxt_t7ZIiGRBYFuWtwX-Gy52Sqq6hHSPm3T-pjwfkl0kV9owr2uJyx7KF3NyBCYkEjP4IoRcsAgMu296l6Mr0ubc"/>
</div>
</div>
</div>
</header>
...
<h1 class="text-3xl font-extrabold text-on-surface tracking-tight">Paramétrage des Maquettes</h1>
<p class="text-on-surface-variant mt-1 text-sm">Définissez les coefficients, crédits et volumes horaires par unité d'enseignement.</p>
</header>
...
<label class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Département d'attache</label>
...
<option>Mathématiques &amp; Informatique</option>
<option>Économie &amp; Gestion</option>
</select>
</div>
<div class="flex-1 w-full">
<label class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Filière d'Étude</label>
<select class="w-full bg-surface-container-low border-none rounded-lg text-sm font-medium focus:ring-2 focus:ring-primary/20 py-3">
<option>Génie Logiciel (Licence)</option>
<option>Réseaux &amp; Télécoms (Licence)</option>
...
<span class="text-[0.65rem] font-bold uppercase tracking-[0.2em] opacity-80">Résumé de l'UE</span>
...
<h4 class="text-xs font-black text-slate-400 uppercase px-2 mb-4">Unités du Semestre</h4>
...
<span class="text-sm font-bold text-slate-600 leading-tight">SOC104 - Sociologie Numérique</span>
</button>
</aside>
...
<h2 class="font-bold text-slate-800">Éléments Constitutifs (EC)</h2>
...
<th class="px-6 py-4 text-[0.65rem] font-black text-slate-500 uppercase tracking-widest">Désignation</th>
...
<input class="bg-surface-container-low border-none rounded md py-1.5 px-2 text-xs text-center w-10" title="Travaux Dirigés" type="text" value="10"/>
...
<td class="px-6 py-4">
<input class="bg-surface-container-low border-none rounded md py-1.5 px-3 text-sm w-full font-medium" type="text" value="Structures de Données Linéaires"/>
</td>
<td class="px-6 py-4 text-center">
<input class="bg-surface-container-low border-none rounded md py-1.5 px-2 text-sm text-center font-bold w-16" step="0.5" type="number" value="2.0"/>
</td>
...
<div class="px-4 py-2 bg-white rounded-lg border border-slate-200">
<span class="text-[0.65rem] font-bold text-slate-400 block uppercase">Total Crédits UE</span>
...
<div>
<p class="text-xs font-bold text-tertiary uppercase mb-1">Attention Règlementaire</p>
<p class="text-sm text-on-tertiary-fixed-variant leading-relaxed">
                                Toute modification des coefficients après le début du semestre nécessite l'approbation du conseil scientifique du département. Les changements seront historisés.
                            </p>
</div>
</div>
</div>
