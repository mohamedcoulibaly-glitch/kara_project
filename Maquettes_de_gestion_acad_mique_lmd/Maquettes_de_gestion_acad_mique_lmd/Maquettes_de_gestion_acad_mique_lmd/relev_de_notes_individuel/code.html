...
<div class="p-6">
<h2 class="font-bold text-blue-800 text-lg">Gestion Académique</h2>
<p class="text-xs text-slate-500 font-medium">Système LMD</p>
</div>
...
<img alt="Photo de profil de l'étudiant" class="w-8 h-8 rounded-full border border-outline-variant" data-alt="User profile photo of a male student" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDPycg_MUhFu6EDprvM00V9afLJIqZCI_qSwZotVJun-ViGfcbrCQH1tjjg0erUoj8xzGPGDuPrvB9r2Fn1xB4jdNVOI3LzWKjSTqou-ogLbnEe5gKmykm7gkTdP4m8YU9C6gwD1vrtC74XZA8K_OpLqydwnUSd6mGajFl2B2B1LMWPmjaw47NKf8166LIeELSFgOKhi4zVwizrGp-DwPVAmjEKTmiZSQzXa1uf1EYkpw6I4eF6nk7lPhWczu0QFNzaI-bF8QEzdWo"/>
</div>
</header>
...
<div>
<span class="text-xs font-bold text-primary tracking-widest uppercase">Fiche Étudiant</span>
<h2 class="text-3xl font-extrabold text-on-surface mt-1">KOUAMÉ Jean-Luc Koffi</h2>
<p class="text-on-surface-variant font-medium">Licence Génie Logiciel — Semestre 5</p>
</div>
...
<div class="space-y-1">
<p class="text-xs text-outline font-semibold uppercase">Année Académique</p>
...
<p class="text-xs font-medium opacity-80 mt-1 uppercase">Moyenne Générale</p>
</div>
</div>
...
<div>
<p class="text-4xl font-extrabold tracking-tight text-on-surface">4<sup>ème</sup></p>
...
<p class="text-xs font-medium text-outline mt-1 uppercase">Crédits ECTS</p>
</div>
</div>
...
<p class="text-xs font-medium text-on-secondary-container opacity-80 mt-1 uppercase">Statut Année</p>
</div>
</div>
</div>
</section>
...
<h3 class="text-xl font-bold text-on-surface">Détails des Unités d'Enseignement</h3>
...
<tr>
<th class="px-6 py-4">Code &amp; Libellé UE</th>
<th class="px-6 py-4 text-right">Crédits</th>
...
<span class="text-sm font-bold text-on-surface">Développement Logiciel Avancé</span>
</div>
</td>
...
<span class="px-3 py-1 bg-secondary-container text-on-secondary-container text-[10px] font-bold rounded-full uppercase tracking-wider">Validé</span>
</td>
...
<span class="text-sm font-bold text-on-surface">Base de Données et Big Data</span>
</div>
</td>
...
<p>© 2024 Academia LMD — Document Généré Automatiquement</p>
<div class="flex gap-6">
<span class="flex items-center gap-2"><span class="material-symbols-outlined text-sm" data-icon="lock">lock</span> Données Certifiées</span>
<span class="flex items-center gap-2"><span class="material-symbols-outlined text-sm" data-icon="verified_user">verified_user</span> Signature Numérique Active</span>
</div>
</footer>
</div>
</main>
