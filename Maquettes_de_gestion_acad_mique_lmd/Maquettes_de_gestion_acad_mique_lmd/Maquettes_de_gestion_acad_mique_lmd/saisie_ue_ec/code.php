...
<span class="font-medium text-sm">Départements</span>
</a>
<a class="flex items-center gap-3 px-4 py-3 rounded-lg text-slate-600 hover:bg-[#f2f4f6] transition-colors duration-200" href="#">
<span class="material-symbols-outlined">account_tree</span>
<span class="font-medium text-sm">Filières</span>
</a>
...
<span class="font-medium text-sm">Unités d'Enseignement</span>
</a>
<a class="flex items-center gap-3 px-4 py-3 rounded-lg text-slate-600 hover:bg-[#f2f4f6] transition-colors duration-200" href="#">
<span class="material-symbols-outlined">menu_book</span>
<span class="font-medium text-sm">Éléments Constitutifs</span>
</a>
<a class="flex items-center gap-3 px-4 py-3 rounded-lg text-slate-600 hover:bg-[#f2f4f6] transition-colors duration-200" href="#">
...
<h2 class="text-xl font-black text-[#1A56DB]">Système de Gestion Académique</h2>
...
<h3 class="text-3xl font-extrabold text-on-surface tracking-tight">Gestion des Unités d'Enseignement</h3>
<p class="text-slate-500 mt-1">Définissez la structure pédagogique du semestre en cours.</p>
</div>
</div>
<!-- Editor Grid -->
...
<h4 class="text-lg font-bold">Nouvelle Unité (UE)</h4>
</div>
...
<div class="col-span-1">
<label class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Crédits ECTS</label>
...
<label class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Libellé de l'Unité</label>
<input class="w-full bg-surface-container-low border-none rounded-lg px-4 py-3 text-sm focus:bg-white focus:ring-2 focus:ring-primary-container transition-all" placeholder="Ex: Algorithmique et Structures de Données" type="text"/>
</div>
</div>
<!-- Dynamic EC Section -->
<div class="pt-6 border-t border-slate-100 space-y-4">
<div class="flex items-center justify-between mb-2">
<h5 class="text-sm font-bold text-slate-700">Éléments Constitutifs (EC)</h5>
...
<div class="flex-1">
<label class="block text-[10px] font-bold text-slate-400 uppercase mb-1">Nom de l'EC</label>
<input class="w-full bg-surface-container-low border-none rounded-lg px-4 py-2 text-xs focus:bg-white focus:ring-1 focus:ring-primary transition-all" type="text" value="Structures de données"/>
</div>
<div class="w-24">
<label class="block text-[10px] font-bold text-slate-400 uppercase mb-1">Coefficient</label>
...
<button class="w-full bg-primary py-4 text-white rounded-lg font-bold text-sm shadow-lg shadow-primary/20 hover:bg-primary-container transition-all active:scale-[0.99] mt-4">
                                ENREGISTRER L'UNITÉ D'ENSEIGNEMENT
                            </button>
</form>
</div>
<!-- Form Tips -->
...
<p class="text-xs text-on-secondary-container/80 mt-1 leading-relaxed">
                                    La somme des coefficients des EC doit être proportionnelle aux crédits ECTS de l'UE pour maintenir la cohérence du système de notation.
                                </p>
</div>
</div>
</div>
...
<h5 class="text-base font-bold text-slate-800 leading-tight mb-2">Bases de Données Avancées</h5>
...
<span class="text-xs font-semibold text-slate-500">3 Éléments (EC)</span>
</div>
...
<h5 class="text-base font-bold text-slate-800 leading-tight mb-2">Analyse Mathématique I</h5>
<div class="mt-auto pt-6 flex items-center justify-between border-t border-slate-50">
<div class="flex items-center gap-2">
<span class="material-symbols-outlined text-secondary text-sm">history_edu</span>
<span class="text-xs font-semibold text-slate-500">2 Éléments (EC)</span>
</div>
<div class="bg-secondary-container px-3 py-1 rounded-full">
...
<div class="flex items-center gap-2">
<span class="material-symbols-outlined text-secondary text-sm">history_edu</span>
<span class="text-xs font-semibold text-slate-500">1 Élément (EC)</span>
</div>
<div class="bg-secondary-container px-3 py-1 rounded-full">
...
<p class="text-xs font-bold text-slate-400 mt-2 uppercase tracking-widest">Ajouter une nouvelle unité</p>
</div>
</div>
<!-- Statistics / Summary -->
