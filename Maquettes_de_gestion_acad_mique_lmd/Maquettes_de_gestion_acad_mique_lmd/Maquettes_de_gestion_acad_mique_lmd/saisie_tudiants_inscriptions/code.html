...
<title>Saisie Étudiants - Portail Académique LMD</title>
...
<input class="pl-10 pr-4 py-1.5 bg-surface-container-low border-none rounded-full text-sm w-64 focus:ring-2 focus:ring-primary/20" placeholder="Rechercher un étudiant..." type="text"/>
</div>
...
<!-- Page Header -->
<div class="mb-10">
<h3 class="text-3xl font-extrabold tracking-tight text-on-surface mb-2">Inscription Étudiant</h3>
<p class="text-slate-500 max-w-2xl">Enregistrez un nouvel étudiant dans le système LMD. Assurez-vous que toutes les informations d'état civil correspondent aux pièces officielles.</p>
</div>
...
<option disabled="" selected="" value="">Sélectionner une filière</option>
<option>Informatique de Gestion (L1)</option>
<option>Génie Logiciel (L2)</option>
<option>Réseaux &amp; Télécoms (L1)</option>
<option>Cyber-sécurité (M1)</option>
...
<input class="w-full bg-surface-container-low border-none rounded-lg py-3 px-4 text-sm focus:ring-2 focus:ring-primary/20 focus:bg-white transition-all outline-none" placeholder="Entrez les prénoms" type="text"/>
</div>
<!-- Date de naissance -->
<div class="md:col-span-1">
...
<button class="px-6 py-3 rounded-lg font-bold text-sm text-slate-500 hover:bg-slate-100 transition-colors">Réinitialiser</button>
...
<p class="text-sm font-medium text-slate-600">Glissez-déposez la photo ici</p>
...
<p class="text-[11px] text-slate-500 leading-relaxed">Format recommandé : 4x4cm, fond uni blanc ou bleu clair, visage centré.</p>
</div>
</div>
</div>
...
<p class="text-[10px] opacity-80">Objectif journalier atteint à 65%</p>
</div>
</div>
...
<div>
<h4 class="text-xl font-bold">Derniers Étudiants Inscrits</h4>
...
<p class="text-xs text-slate-500">Né le 12/05/2003</p>
</div>
</div>
</td>
<td class="px-6 py-4 text-sm font-medium text-slate-600">LMD-2024-156</td>
<td class="px-6 py-4 text-sm text-slate-600">Génie Logiciel (L3)</td>
...
<p class="text-xs text-slate-500">Né le 25/08/2004</p>
</div>
</div>
</td>
...
<p class="text-xs text-slate-500">Né le 05/01/2002</p>
</div>
</div>
</td>
<td class="px-6 py-4 text-sm font-medium text-slate-600">LMD-2024-158</td>
<td class="px-6 py-4 text-sm text-slate-600">Cyber-sécurité (M1)</td>
