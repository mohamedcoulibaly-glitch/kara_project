<?php
// Création des tables de base de données manquantes (version corrigée)
...
// Table generated_reports (sans foreign keys pour éviter les erreurs)
...
// Table exports_history (sans foreign keys pour éviter les erreurs)
$exports_history_sql = "
