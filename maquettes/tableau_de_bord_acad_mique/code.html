...
<p class="text-sm text-slate-500">65% des étudiants ont déjà validé l'intégralité de leurs UE du semestre en cours.</p>
</div>
</div>
<div class="bg-surface-container-low rounded-xl p-6 flex items-center gap-6">
<div class="w-16 h-16 bg-white rounded-xl shadow-sm flex items-center justify-center">
...
<p class="text-sm text-slate-500">Une baisse de 12% des passages en rattrapage est observée par rapport à l'année N-1.</p>
</div>
</div>
</div>
</div>
