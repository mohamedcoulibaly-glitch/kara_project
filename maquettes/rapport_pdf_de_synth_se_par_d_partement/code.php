...
<a class="text-slate-500 hover:text-blue-600 transition-colors" href="#">Départements</a>
<a class="text-blue-700 font-semibold border-b-2 border-blue-700 pb-1" href="#">Rapports</a>
<a class="text-slate-500 hover:text-blue-600 transition-colors" href="#">Paramètres</a>
</nav>
</div>
...
<h2 class="font-black text-blue-800 text-lg">Faculté des Sciences</h2>
...
<span class="material-symbols-outlined text-xl" data-icon="analytics">analytics</span> Synthèse Globale
            </a>
...
<a class="text-slate-400 hover:text-slate-600 py-1 flex items-center gap-2 text-xs uppercase tracking-widest font-semibold" href="#">
<span class="material-symbols-outlined text-sm" data-icon="logout">logout</span> Déconnexion
                </a>
</div>
</div>
</aside>
...
<h1 class="text-2xl font-headline font-bold text-on-surface tracking-tight">Prévisualisation du Rapport</h1>
<p class="text-sm text-on-surface-variant">Département Informatique • Généré le 24 Mai 2024</p>
</div>
...
<span class="material-symbols-outlined text-lg" data-icon="download">download</span> Télécharger PDF
                </button>
...
<div>
<h3 class="font-bold text-slate-800 text-lg leading-tight">Université des Sciences Appliquées</h3>
<p class="text-xs text-slate-500 uppercase tracking-widest font-semibold">Direction des Études &amp; Examens</p>
</div>
</div>
<div class="text-right">
<h2 class="text-sm font-bold text-primary tracking-widest uppercase">Rapport de Synthèse Académique</h2>
<p class="text-xs text-slate-600 font-medium">Année Académique 2023-2024</p>
...
<h4 class="text-xs font-black uppercase tracking-[0.2em] text-slate-400">01. Résumé Exécutif</h4>
</div>
<div class="grid grid-cols-3 gap-6">
<div class="bg-surface-container-low p-6 rounded-lg text-center">
<p class="text-xs font-semibold text-slate-500 uppercase mb-2">Taux de Réussite</p>
...
<div class="bg-surface-container-low p-6 rounded-lg text-center">
<p class="text-xs font-semibold text-slate-500 uppercase mb-2">Moyenne Générale</p>
...
<p class="text-[10px] text-slate-400 font-bold uppercase mt-2">Étudiants Inscrits</p>
</div>
</div>
</section>
<!-- 2. Détail par Filière -->
<section>
<div class="flex items-center gap-2 mb-6">
<div class="h-1 w-8 bg-primary rounded-full"></div>
<h4 class="text-xs font-black uppercase tracking-[0.2em] text-slate-400">02. Détail par Filière</h4>
</div>
...
<th class="px-6 py-4">Filière d'Étude</th>
<th class="px-6 py-4 text-center">Effectif</th>
<th class="px-6 py-4 text-right">Taux de Validation</th>
<th class="px-6 py-4 text-right">Moyenne Filière</th>
</tr>
</thead>
<tbody class="text-sm divide-y divide-slate-50">
<tr class="hover:bg-slate-50 transition-colors">
<td class="px-6 py-4 font-semibold text-slate-700">Licence Génie Logiciel</td>
...
<tr class="hover:bg-slate-50 transition-colors">
<td class="px-6 py-4 font-semibold text-slate-700">Licence Cybersécurité</td>
...
<tr class="hover:bg-slate-50 transition-colors">
<td class="px-6 py-4 font-semibold text-slate-700">Master Réseaux &amp; Télécoms</td>
...
<!-- 3. Répartition des Mentions (Visual Chart Simulation) -->
<section>
<div class="flex items-center gap-2 mb-6">
<div class="h-1 w-8 bg-primary rounded-full"></div>
<h4 class="text-xs font-black uppercase tracking-[0.2em] text-slate-400">03. Répartition des Mentions</h4>
</div>
...
<span class="text-[10px] font-bold uppercase text-slate-400 text-center">Très Bien</span>
</div>
<div class="flex-1 flex flex-col items-center gap-3">
...
<span class="text-[10px] font-bold uppercase text-slate-400 text-center">Ajourné</span>
</div>
</div>
</section>
</div>
...
<p class="text-[10px] font-bold uppercase text-slate-400 mb-20">Le Chef de Département</p>
<div class="w-48 h-px bg-slate-200 mx-auto"></div>
<p class="text-xs font-semibold text-slate-600 mt-2">Dr. Jean-Pierre AMANI</p>
</div>
<div class="text-center">
<p class="text-[10px] font-bold uppercase text-slate-400 mb-20">Le Doyen de la Faculté</p>
<div class="w-48 h-px bg-slate-200 mx-auto"></div>
<p class="text-xs font-semibold text-slate-600 mt-2">Pr. Hélène DUBOIS</p>
</div>
</div>
<!-- Meta Info Document -->
...
<a class="text-xs uppercase tracking-widest font-semibold text-slate-400 hover:text-slate-600 underline underline-offset-4 opacity-80 hover:opacity-100 transition-opacity" href="#">Mentions Légales</a>
...
<p class="text-[10px] text-slate-400 tracking-wider">© 2024 LMD Horizon - Système de Gestion Académique Certifié</p>
</footer>
</body></html>