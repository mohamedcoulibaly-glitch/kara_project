...
if (basename($_SERVER['PHP_SELF']) === 'repertoire_etudiants_backend.php') {
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
        <div>
            ...
            <p class="text-slate-500 mt-1 max-w-2xl">Consultez, recherchez et gérez tous les étudiants inscrits dans
                l'établissement.</p>
        </div>
                ...
                <table class="w-full">
                    <thead>
                        <tr class="bg-surface-container-low border-b border-outline-variant/20">
                            ...
                            <th class="text-left py-3 px-4 text-xs font-bold text-slate-500 uppercase tracking-wider">Matricule
                            </th>
                            <th class="text-left py-3 px-4 text-xs font-bold text-slate-500 uppercase tracking-wider">Nom &
                                Prénom</th>
                            <th class="text-left py-3 px-4 text-xs font-bold text-slate-500 uppercase tracking-wider">Filière
                            </th>
                            <th class="text-left py-3 px-4 text-xs font-bold text-slate-500 uppercase tracking-wider">
                                Département</th>
                            <th class="text-left py-3 px-4 text-xs font-bold text-slate-500 uppercase tracking-wider">Statut
                            </th>
                            <th class="text-left py-3 px-4 text-xs font-bold text-slate-500 uppercase tracking-wider">Actions
                            </th>
                        </tr>
                    </thead>
                        ...
                        <?php foreach ($etudiants as $etudiant): ?>
                            <tr class="hover:bg-surface-container-low/50 transition-colors">
                                ...
                                <td class="py-3 px-4 text-sm text-slate-600">
                                    <?= htmlspecialchars($etudiant['nom_filiere'] ?? 'N/A') ?></td>
                                <td class="py-3 px-4 text-sm text-slate-600"><?= htmlspecialchars($etudiant['nom_dept'] ?? 'N/A') ?>
                                </td>
                                <td class="py-3 px-4">
                                    <?php
                                    ...
                                    ?>
                                    <span
                                        class="inline-flex items-center gap-1 px-2 py-1 <?= $statut_class ?> rounded-full text-xs font-semibold">
                                ...
                                <td class="py-3 px-4">
                                    <div class="flex items-center gap-1">
                                        <a href="<?= $base_url ?>backend/parcours_academique_backend.php?id=<?= $etudiant['id_etudiant'] ?>"
                                            class="p-1.5 rounded-lg hover:bg-primary/10 text-primary transition-all"
                                            title="Parcours">
                                        ...
                                        <a href="<?= $base_url ?>backend/relev_backend.php?id=<?= $etudiant['id_etudiant'] ?>"
                                            class="p-1.5 rounded-lg hover:bg-blue-50 text-blue-600 transition-all"
                                            title="Relevé de Notes">
                                            <span class="material-symbols-outlined text-lg">description</span>
                                        </a>
                                        <a href="<?= $base_url ?>backend/carte_etudiant_backend.php?id=<?= $etudiant['id_etudiant'] ?>"
                                            class="p-1.5 rounded-lg hover:bg-green-50 text-green-600 transition-all"
                                            title="Carte Étudiant">
                                            <span class="material-symbols-outlined text-lg">badge</span>
                                        </a>
                                        <a href="<?= $base_url ?>backend/attestation_backend.php?id=<?= $etudiant['id_etudiant'] ?>"
                                            class="p-1.5 rounded-lg hover:bg-purple-50 text-purple-600 transition-all"
                                            title="Attestation">
